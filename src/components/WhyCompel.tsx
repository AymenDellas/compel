  ...
  return (
    <div className="w-full bg-black border border-neutral-800 rounded-lg p-3 font-mono text-[10px] text-neutral-400 mt-6 space-y-2 shadow-inner">
      <div className="flex justify-between items-center border-b border-neutral-800 pb-2">
        ...
        <span className="text-neutral-500">latency_ms</span>
      </div>
      {logs.map((log, i) => (
  ...
  return (
    <section className="py-32 px-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        <div className="md:col-span-2 bg-[#0A0A0A] border border-neutral-800 rounded-3xl p-8 md:p-12 flex flex-col lg:flex-row gap-8 items-center overflow-hidden relative">
          ...
          <div className="flex-1 w-full flex flex-col md:flex-row h-auto md:h-64 rounded-xl border border-white/10 overflow-hidden relative">
            ...
            <div className="w-full md:w-1/2 h-48 md:h-full bg-neutral-950 p-4 relative border-t md:border-t-0 md:border-l border-neutral-800">
               ...
               <div className="w-full h-20 border border-neutral-700 bg-neutral-900 mb-3 relative flex items-center justify-center text-[10px] font-mono text-neutral-500">
                  HERO_AREA
               </div>
        ...
        <div className="bg-[#0A0A0A] border border-neutral-800 rounded-3xl p-8 md:p-10 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="font-mono text-xs text-neutral-600 tracking-widest uppercase relative z-10">
            // Direct Comm Channel
          </div>
        </div>
