...
Why is measuring the ROI of coaching notoriously difficult? 
Unlike a new piece of manufacturing equipment where the output increase can be measured instantly, coaching involves complex human behavioral changes that ripple through an organization over time. 
...
This is a critical mistake. To command the fees discussed in our [cpa-high-ticket](/learn/cpa-high-ticket) model, you must bridge the gap between behavioral change and business impact. 
...
1.  **Reaction:** Did the coachee find the sessions valuable and relevant? (Measured via immediate post-session feedback).
2.  **Learning:** Did the coachee acquire new skills, frameworks, or awareness? (Measured via self-assessments or role-play).
3.  **Application:** Is the coachee actually applying the new skills on the job? (Measured via 360-degree feedback from peers and subordinates 3-6 months later).
4.  **Business Impact:** Did the application of these skills move the needle on business metrics? (Measured via retention rates, revenue growth, or specific project KPIs).
5.  **ROI Calculation:** Convert the business impact into a monetary value and compare it to the cost of the coaching program. 
...
You cannot retroactively measure ROI effectively. Data collection must be engineered into your process from day one. This is a critical component of a high-functioning business model, whether you are in executive coaching, [business coaching](/coaches/business-coaching), or [performance coaching](/coaches/performance-coaching).
...
During a [discovery call](/learn/coaching-discovery-call-script), a prospect might hesitate at a $40,000 price tag. This is where you pivot from ROI to COI (Cost of Inaction).
